    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_image', main.models.ImageField(blank=True, null=True, upload_to=settings.MEDIA_ROOT)),
                ('definition', models.CharField(max_length=512)),
                ('definition_image', main.models.ImageField(blank=True, null=True, upload_to=settings.MEDIA_ROOT)),
